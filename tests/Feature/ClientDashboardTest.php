    ...
    public function test_dashboard_shows_counts_scoped_to_the_client(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->has('quickActions', 4)
                ->where('quickActions.0.href', route('client.projects.index'))
                ->where('quickActions.1.href', route('client.support-tickets.index'))
                ->where('quickActions.2.href', route('client.support-tickets.create'))
                ->where('quickActions.3.href', route('client.notifications.index'))
